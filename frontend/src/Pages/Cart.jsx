    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-4xl  bg-slate-200 p-8 rounded-lg shadow-md">
        ...
        <div className="flex flex-wrap justify-center">
          ...
          <span className="bg-pink-500 text-white px-4 py-2 rounded-full m-2">Php</span>
          <span className="bg-indigo-500 text-white px-4 py-2 rounded-full m-2">SQL</span>
          <span className="bg-red-300 text-white px-4 py-2 rounded-full m-2">AWS</span>
          <span className="bg-red-500 text-white px-4 py-2 rounded-full m-2">Flutter</span>
